      ...
      <div className="relative z-10 w-full max-w-sm animate-fade-in">
        ...
        <div className="bg-[#110e1a] border border-rose-500/20 rounded-3xl p-8 shadow-2xl backdrop-blur-md">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-white hover:bg-zinc-100 active:bg-zinc-200 text-zinc-900 rounded-xl font-bold text-sm transition-all duration-200 shadow-xl disabled:opacity-50"
          >
            {isLoggingIn ? (
